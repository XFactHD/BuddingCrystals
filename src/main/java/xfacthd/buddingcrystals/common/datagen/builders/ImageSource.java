...
public abstract class ImageSource
{
    ...
    protected ImageSource(ExistingFileHelper fileHelper, String type)
    {
    ...
    protected final void checkExists(ResourceLocation texture)
    {
        Preconditions.checkArgument(
                fileHelper.exists(texture, TextureConfigProvider.TEXTURE),
    ...
    public static final class File extends ImageSource
    {
        ...
        File(ExistingFileHelper fileHelper, ResourceLocation texture)
        {
            super(fileHelper, "dynamic_asset_generator:texture");
        ...
        JsonObject toJson()
        {
            Preconditions.checkNotNull(texture, "No texture set");

            JsonObject object = super.toJson();
            object.addProperty("path", texture.toString());
            return object;
        }
    }
    ...
    public static final class FallbackFile extends ImageSource
    {
        ...
        FallbackFile(ExistingFileHelper fileHelper) { super(fileHelper, BuddingCrystals.MOD_ID + ":fallback_texture"); }

        public FallbackFile texture(ResourceLocation texture)
        {
            Preconditions.checkNotNull(texture, "Texture must not be null");
            checkExists(texture);
    ...
    public static final class Color extends ImageSource
    {
        ...
        Color(ExistingFileHelper fileHelper) { super(fileHelper, "dynamic_asset_generator:color"); }
    ...
    public static final class Overlay extends ImageSource
    {
        ...
        Overlay(ExistingFileHelper fileHelper) { super(fileHelper, "dynamic_asset_generator:overlay"); }

        public Overlay source(ImageSource source)
        {
            Preconditions.checkNotNull(source, "Source most not be null");
            sources.add(source);
            return this;
        }
        ...
        JsonObject toJson()
        {
            JsonArray sourceArray = new JsonArray(sources.size());
            sources.forEach(src -> sourceArray.add(src.toJson()));

            JsonObject object = super.toJson();
            object.add("inputs", sourceArray);
            return object;
        }
    }
    ...
    public static final class Mask extends ImageSource
    {
        ...
        Mask(ExistingFileHelper fileHelper) { super(fileHelper, "dynamic_asset_generator:mask"); }
    ...
    public static final class Crop extends ImageSource
    {
        ...
        Crop(ExistingFileHelper fileHelper) { super(fileHelper, "dynamic_asset_generator:crop"); }
    ...
    public static final class Transform extends ImageSource
    {
        ...
        Transform(ExistingFileHelper fileHelper) { super(fileHelper, "dynamic_asset_generator:transform"); }
    ...
    public static final class CombinedPalettedImage extends ImageSource
    {
        ...
        CombinedPalettedImage(ExistingFileHelper fileHelper)
        {
            super(fileHelper, "dynamic_asset_generator:combined_paletted_image");
        }
    ...
    public static final class ForegroundTransfer extends ImageSource
    {
        ...
        ForegroundTransfer(ExistingFileHelper fileHelper) { super(fileHelper, "dynamic_asset_generator:foreground_transfer"); }
